...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/ADC/style.css">
    </head>
...
//                                                    window.location.href = 'https://accounts.google.com/o/oauth2/auth?client_id=467259931658-l9qjqa88k7ku4sqi8ldhebkkbc0rtc45.apps.googleusercontent.com&redirect_uri=http://localhost:8079/ADC/logout&scope=email &response_type=token';
            ...
            <h2 style="color:red;">EDIT HOSTEL DETAILS</h2>
            <input type="button" style="" onclick="window.location.href = 'headdrop.jsp';" value="Click here to edit room details">
    ...
    <center>
        <button class="mt-5" id="hoo" onclick="addRow(this);">ADD ROW
    ...
    <script>
       function myFunction() {
           ...
           var link = "/ADC/admin/display.jsp?hostel=" + hostel + "&floor=" + floor;
...
//            
        x.style.display = 'none';
           var floor = document.getElementById("floor").value;
           var hostel = document.getElementById("hostel").value;
           var link = "/ADC/admin/editrow.jsp?hostel=" + hostel + "&floor=" + floor;
